...
public class Ball : MonoBehaviour
{
    ...
    public virtual void Start()
    {
        ...
        {
            points = (int)ConfigurationUtils.StandardPoints;
            hits = (int)ConfigurationUtils.StandardHits;
        }
        else if (ballType == BallType.Bonus)
        {
            points = (int)ConfigurationUtils.BonusPoints;
            hits = (int)ConfigurationUtils.BonusHits;
        }
    ...
    void StartMoving()
    {
        ...
        Vector2 force = new Vector2(
            (float)Mathf.Cos(angle) * GameUtils.MinImpulseForce,
            (float)Mathf.Sin(angle) * GameUtils.MinImpulseForce);
